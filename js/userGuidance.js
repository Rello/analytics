...
OCA.Analytics.Wizard = {
    ...
    demo: function () {
        ...
        let population = '{"report":{"name":"' + t('analytics', 'Demo: Population Data') + '","type":4,"link":"{\\"link\\":\\"https:\\/\\/raw.githubusercontent.com\\/Rello\\/analytics\\/master\\/sample_data\\/sample1.csv\\",\\"columns\\":\\"\\",\\"offset\\":\\"\\"}","visualization":"ct","chart":"line","dimension1":"","dimension2":"","dimension3":null,"subheader":"' + t('analytics', 'Realtime CSV Data from GitHub via the \\"Extrernal URL\\') + '" datasource","chartoptions":"","dataoptions":"","filteroptions":null,"value":""},"dataload":[],"threshold":[],"favorite":"true"}';
        OCA.Analytics.Sidebar.Report.import(null, population);

        let github = '{"report":{"name":"' + t('analytics', 'Demo: Analytics Downloads') + '","type":3,"link":"{\\"user\\":\\"rello\\",\\"repository\\":\\"analytics\\",\\"limit\\":\\"10\\",\\"timestamp\\":\\"false\\"}","visualization":"ct","chart":"column","dimension1":"' + t('analytics', 'Object') + '","dimension2":"' + t('analytics', 'Date') + '","dimension3":"' + t('analytics', 'Value') + '","subheader":"' + t('analytics', 'Realtime download statistics form Github') + '","chartoptions":"","dataoptions":"","filteroptions":null,"value":"Value"},"dataload":[],"threshold":[{"id":33,"dimension1":"*","dimension2":null,"value":"5000.00","option":">","severity":4}],"favorite":"true"}';
