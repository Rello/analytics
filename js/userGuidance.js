...
OCA.Analytics.Wizard = {
    ...
    demo: function () {
        let thresholds = '{"report":{"name":"' + t('analytics', 'Demo: Thresholds') + '","type":2,"link":"{}","visualization":"table","chart":"","dimension1":"' + t('analytics', 'Type') + '","dimension2":"' + t('analytics', 'Thresholds') + '","dimension3":"' + t('analytics', 'Value') + '","subheader":"' + t('analytics', 'Thresholds can be used to highlight data. Using the notification threshold, push messages are being sent') + '","chartoptions":"","dataoptions":"","filteroptions":"{}","value":"Value"},"dataload":[],"threshold":[{"id":94,"dimension1":"Threshold","dimension2":null,"value":"1.00","option":"=","severity":4},{"id":95,"dimension1":"Threshold","dimension2":null,"value":"2.00","option":"=","severity":3},{"id":97,"dimension1":"Threshold","dimension2":null,"value":"4.00","option":"=","severity":1},{"id":98,"dimension1":"Threshold","dimension2":null,"value":"3.00","option":">=","severity":2}],"favorite":"","data":[["' + t('analytics', 'Normal value') + '","' + t('analytics', 'none') + '","3.00"],["' + t('analytics', 'Threshold') + '","' + t('analytics', 'Green') + '","1.00"],["' + t('analytics', 'Threshold') + '","' + t('analytics', 'none') + '","0.00"],["' + t('analytics', 'Threshold') + '","' + t('analytics', 'Notification') + '","4.00"],["' + t('analytics', 'Threshold') + '","' + t('analytics', 'Red') + '","3.00"],["' + t('analytics', 'Threshold') + '","' + t('analytics', 'Yellow') + '","2.00"]],"favorite":"true"}';
        OCA.Analytics.Sidebar.Report.import(null, thresholds);

        let population = '{"report":{"name":"' + t('analytics', 'Demo: Population Data') + '","type":4,"link":"{\\"link\\":\\"https:\\/\\/raw.githubusercontent.com\\/Rello\\/analytics\\/master\\/sample_data\\/sample1.csv\\",\\"columns\\":\\"\\",\\"offset\\":\\"\\"}","visualization":"ct","chart":"line","dimension1":"","dimension2":"","dimension3":null,"subheader":"' + t('analytics', 'Real-time CSV data from GitHub via the *External URL*') + '" datasource","chartoptions":"","dataoptions":"","filteroptions":null,"value":""},"dataload":[],"threshold":[],"favorite":"true"}';
        OCA.Analytics.Sidebar.Report.import(null, population);

        let github = '{"report":{"name":"' + t('analytics', 'Demo: Analytics Downloads') + '","type":3,"link":"{\\"user\\":\\"rello\\",\\"repository\\":\\"analytics\\",\\"limit\\":\\"10\\",\\"timestamp\\":\\"false\\"}","visualization":"ct","chart":"column","dimension1":"' + t('analytics', 'Object') + '","dimension2":"' + t('analytics', 'Date') + '","dimension3":"' + t('analytics', 'Value') + '","subheader":"' + t('analytics', 'Real-time download statistics from GitHub') + '","chartoptions":"","dataoptions":"","filteroptions":null,"value":"Value"},"dataload":[],"threshold":[{"id":33,"dimension1":"*","dimension2":null,"value":"5000.00","option":">","severity":4}],"favorite":"true"}';
        OCA.Analytics.Sidebar.Report.import(null, github);

        let finance = '{"report":{"name":"' + t('analytics', 'Demo: Finance') + '","type":2,"link":"{}","visualization":"ct","chart":"column","dimension1":"' + t('analytics', 'Segment') + '","dimension2":"' + t('analytics', 'Year') + '","dimension3":null,"subheader":"' + t('analytics', 'Sales and revenue of the last years') + '","chartoptions":"","dataoptions":"[{\\"yAxisID\\":\\"primary\\",\\"type\\":\\"bar\\"},{\\"yAxisID\\":\\"primary\\",\\"type\\":\\"bar\\"},{\\"yAxisID\\":\\"primary\\",\\"type\\":\\"bar\\"},{\\"yAxisID\\":\\"primary\\",\\"type\\":\\"line\\"}]","filteroptions":"{\\"filter\\":{\\"dimension2\\":{\\"option\\":\\"GT\\",\\"value\\":\\"2011\\"}}}","value":"\u20ac"},"dataload":[],"threshold":[],"favorite":"","data":[["Channel Partners","2011","30216.00"],["Channel Partners","2012","18540.00"],["Channel Partners","2013","30216.00"],["Channel Partners","2014","4404.00"],["Channel Partners","2015","10944.00"],["Channel Partners","2016","25932.00"],["Channel Partners","2017","18540.00"],["Channel Partners","2018","34056.00"],["Channel Partners","2019","23436.00"],["Channel Partners","2020","25692.00"],["Enterprise","2011","33318.00"],["Enterprise","2012","43125.00"],["Enterprise","2013","25500.00"],["Enterprise","2014","52625.00"],["Enterprise","2015","43125.00"],["Enterprise","2016","52743.00"],["Enterprise","2017","32370.00"],["Enterprise","2018","26420.00"],["Enterprise","2019","52950.00"],["Enterprise","2020","37980.00"],["Government","2011","15022.00"],["Government","2012","5840.00"],["Government","2013","35200.00"],["Government","2014","6181.00"],["Government","2015","8001.00"],["Government","2016","60350.00"],["Government","2017","36340.00"],["Government","2018","59550.00"],["Government","2019","10451.00"],["Government","2020","32100.00"],["Total Sales","2011","78556.00"],["Total Sales","2012","67505.00"],["Total Sales","2013","90916.00"],["Total Sales","2014","63210.00"],["Total Sales","2015","62070.00"],["Total Sales","2016","139025.00"],["Total Sales","2017","87250.00"],["Total Sales","2018","120026.00"],["Total Sales","2019","86837.00"],["Total Sales","2020","95772.00"]]}';
