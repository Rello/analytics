...
OCA.Analytics.Wizard = {
    ...
    demo: function () {
        let thresholds = '{"report":{"name":"' + t('analytics', 'Demo: Thresholds') + '","type":2,"link":"{}","visualization":"table","chart":"","dimension1":"' + t('analytics', 'Type') + '","dimension2":"' + t('analytics', 'Thresholds') + '","dimension3":"' + t('analytics', 'Value') + '","subheader":"' + t('analytics', 'Thresholds can be used to highlight data. Using the notification threshold, push messages are being sent') + '","chartoptions":"","dataoptions":"","filteroptions":"{}","value":"Value"},"dataload":[{"id":105,"user_id":"admin","dataset":103,"datasource":3,"name":"test github","option":"{\\"user\\":\\"a\\",\\"repository\\":\\"a\\",\\"limit\\":\\"1\\",\\"timestamp\\":\\"true\\",\\"delete\\":\\"false\\"}","schedule":""}],"threshold":[{"id":94,"dimension1":"Threshold","dimension2":null,"value":"1.00","option":"=","severity":4},{"id":95,"dimension1":"Threshold","dimension2":null,"value":"2.00","option":"=","severity":3},{"id":97,"dimension1":"Threshold","dimension2":null,"value":"4.00","option":"=","severity":1},{"id":98,"dimension1":"Threshold","dimension2":null,"value":"3.00","option":">=","severity":2}],"favorite":"","data":[["Normal value","none","3.00"],["Threshold","Green","1.00"],["Threshold","none","0.00"],["Threshold","notification","4.00"],["Threshold","Red","3.00"],["Threshold","Yellow","2.00"]],"favorite":"true"}';
        ...
        let github = '{"report":{"name":"' + t('analytics', 'Demo: Analytics Downloads') + '","type":3,"link":"{\\"user\\":\\"rello\\",\\"repository\\":\\"analytics\\",\\"limit\\":\\"10\\",\\"timestamp\\":\\"false\\"}","visualization":"ct","chart":"column","dimension1":"' + t('analytics', 'Object') + '","dimension2":"' + t('analytics', 'Date') + '","dimension3":"' + t('analytics', 'Value') + '","subheader":"' + t('analytics', 'Realtime download statistics form Github') + '","chartoptions":"","dataoptions":"","filteroptions":null,"value":"Value"},"dataload":[{"id":59,"user_id":"admin","dataset":155,"datasource":6,"name":"New","option":"{}","schedule":null}],"threshold":[{"id":33,"dimension1":"*","dimension2":null,"value":"5000.00","option":">","severity":4}],"favorite":"true"}';
