OC.L10N.register(
    ...
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "Denne rapporten har ingen datalaster. <br>Velg en datakilde fra nedtrekksmenyen og trykk \"+\"",
    "Choose a dataload from the list to change its settings" : "Velg en datalast fra listen for å endre dens innstillinger",
    "Saved" : "Lagret",
    "Are you sure?" : "Er du sikker?",
    "Delete dataload" : "Slette datalast",
    "Select file" : "Velg fil",
    "Datasource simulation" : "Datakilde simulering",
    ...
    "Overview" : "Oversikt",
    "Scheduled dataload" : "Planlagt datalast",
    ...
    "Reports can be grouped into a folder structure" : "Rapporter kan grupperes til en mappestruktur",
    ...
    "Type" : "Type",
    "Thresholds can be used to highlight data. Using the notification threshold, push messages are being sent" : "Terskler kan brukes til å fremheve data. Ved bruk av varsel-terskel sendes push meldinger",
    "Threshold" : "Terskel",
    ...
    "Real-time CSV data from GitHub via the *External URL* datasource" : "CSV-data i sanntid fra GitHub via *Ekstern URL* datakilden",
    ...
    "New data has been added to dataset {report} via dataload" : "Nye data har blitt lagt til datasettet {report} via en datalast",
    ...
    "Limit" : "Grense",
    "Timestamp of dataload" : "Datalastens tidsstempel",
