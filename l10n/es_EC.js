OC.L10N.register(
    ...
    "shared report {report} with you" : "compartió el informe {report} contigo",
    ...
    "The EasyPrivacy list is blocking some scripts because of a wildcard '*analytics*' string filter." : "La lista EasyPrivacy está bloqueando algunos scripts debido a un filtro de cadena *analytics* comodín.",
