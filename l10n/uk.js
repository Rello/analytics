OC.L10N.register(
    ...
    "Connect data from different sources in one place.\nUse flexible Panoramas and reports with seamless Nextcloud integration.\nVisualize and share anything, from financial analysis to IoT logs.\n\n\n#### Features:\n- Visualization: **Panoramas**, reports, charts, tables, filters\n- Data sources:\n  - csv, spreadsheet, API, import, manual entry\n  - Nextcloud Files, Forms, Tables\n  - external: GitHub, website grabber, JSON\n- Register external data sources from other apps\n- Storage: **real-time** or database\n- Advanced data loads with scheduling\n- Analysis functions: **trend**, dis-/aggregation\n- Thresholds for alerts and color coding\n- Sharing: user, groups, link\n- Integration: Files, Activity, Notifications, Flow, Dashboard, Search, Smart picker, Translation\n- **AI Assistant**: Context Chat integration" : "З'єднайте дані з різних джерел в одному місці.\nВикористовуйте гнучкі панорами та звіти з безперебійною інтеграцією Nextcloud.\nВізуалізуйте та діліться будь-якою інформацією, від фінансового аналізу до журналів IoT.\n\n\n#### Функції:\n- Візуалізація: **панорами**, звіти, діаграми, таблиці, фільтри\n- Джерела даних:\n- csv, електронні таблиці, API, імпорт, ручне введення\n- Файли, форми, таблиці Nextcloud\n- зовнішні: GitHub, веб-сайт-грабер, JSON\n- Реєстрація зовнішніх джерел даних з інших додатків\n- Зберігання: **в режимі реального часу** або база даних\n- Розширене завантаження даних із плануванням\n- Функції аналізу: **тенденції**, агрегація/дезагрегація\n- Пороги для сповіщень та колірне кодування\n- Спільний доступ: користувач, групи, посилання\n- Інтеграція: файли, активність, сповіщення, потік, панель інструментів, пошук, розумний вибір, переклад\n- **AI Assistant**: інтеграція з Context Chat",
