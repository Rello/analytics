OC.L10N.register(
    ...
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Цей звіт не містить дані для завантаження. <br>Оберіть джерело даних з випадаючого списку та натисніть \"+\"",
    ...
    "Delete data load" : "Видалити завантаження даних",
    ...
    "errors" : "помилки",
    "No maintenance possible" : "Технічне обслуговування неможливе",
    "This dataset is not used!" : "Цей набір даних не використовується!",
    "All data including all reports will be deleted!" : "Усі дані, включаючи всі звіти, будуть видалені!",
    "Delete" : "Вилучити",
    "The dataset name is missing" : "Відсутня назва набору даних",
    "Records to be deleted: " : "Записи для видалення:",
    ...
    "No reports yet" : "Звітів ще немає",
    ...
    "Do you want to create a new group folder?" : "Бажаєте створити нову групову папку?",
    "Report group" : "Звіт групи",
    ...
    "This was the last report on the dataset. Do you want to delete the dataset including all data?" : "Це був останній звіт про набір даних. Ви бажаєте видалити набір даних разом із усіма даними?",
    ...
    "Detail instructions at:" : "Детальні інструкції за адресою:",
    "REST API parameters" : "Параметри REST API",
    "No shares found" : "Акції не знайдено",
    "Add share link" : "Акції не знайдено",
    ...
    "Demo: Analytics Downloads" : "Демо: завантаження Analytics",
    "Object" : "Об'єкт",
    "Date" : "Дата",
    "Real-time download statistics from GitHub." : "Статистика завантажень у реальному часі з GitHub.",
    ...
    "Version" : "Версія",
    "Download count" : "Кількість завантажень",
    "JSON" : "JSON",
    ...
    "Selection" : "Вибір",
    "No data load created yet" : "Завантаження даних ще не створено",
    "Setting" : "Налаштування",
    "Title" : "Назва",
    "Delete data before load" : "Видалити дані перед завантаженням",
    "No" : "Ні",
    "Yes" : "Так",
    "Execution" : "Виконання",
    "Load now" : "Завантажити зараз",
    "Test run" : "Тестовий запуск",
    "Schedule in background" : "Розклад у фоновому режимі",
    "Not scheduled" : "Не заплановано",
    "Daily" : "Щоденно",
    "Hourly" : "Щогодини",
    "Load via OCC command:" : "Завантажити через команду OCC:",
    ...
    "Flexible filters including dynamic date variables" : "Гнучкі фільтри, включаючи динамічні змінні дати",
    "Change drill down by removing columns" : "Змініть деталізацію, видаливши стовпці",
    ...
    "Use data from GitHub to monitor download statistics in real-time" : "Використовуйте дані з GitHub для моніторингу статистики завантажень у реальному часі",
    ...
    "Advanced configuration - Data loads" : "Розширена конфігурація - завантаження даних",
    ...
    "Full (deletion of old data) or delta loads" : "Повне (видалення старих даних) або дельта-завантаження",
