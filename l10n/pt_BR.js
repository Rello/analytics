OC.L10N.register(
    ...
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "Este relatório não possui carregamentos de dados. <br>Escolha uma fonte de dados no menu suspenso e pressione \"+\"",
    "Choose a dataload from the list to change its settings" : "Escolha um carregamento de dados da lista para alterar suas configurações",
    "Saved" : "Salvo",
    ...
    "Scheduled dataload" : "Carregamento de dados agendados",
    ...
    "Column descriptions are derived from the dataset and can not be changed on a report level" : "As descrições das colunas são derivadas do conjunto de dados e não podem ser alteradas no nível do relatório",
    ...
    "New data has been added to dataset {report} via dataload" : "Novos dados foram adicionados ao conjunto de dados {report} via carregamento de dados",
    ...
    "Analytics - Advanced configuration" : "Analytics - configuração avançada",
    "This section is used for dataset maintenance and dataload configurations" : "Esta seção é usada para manutenção de conjunto de dados e configurações de carregamento de dados",
    ...
    "10 min" : "10 min",
    "30 min" : "30 min",
    "New Report Wizard" : "Novo Assistente de Relatório",
    "Choose a name for the report" : "Escolha um nome para o relatório",
    "Subheader" : "Subcabeçalho",
    "Variables" : "Variáveis",
    "Datasource" : "Fonte de dados",
    "Saved Data" : "Salvar Dados",
    "Datasource options" : "Opções de fonte de dados",
    ...
    "Thresholds can trigger notifications and color coding in reports" : "Os limites podem acionar notificações e codificação por cores em relatórios",
    ...
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Os relatórios podem ler seus dados de fontes de dados em tempo real ou de conjuntos de dados salvos no banco de dados Nextcloud.",
    "Different data sources are available. The data is read in realtime when the report is being executed." : "Diferentes fontes de dados estão disponíveis. Os dados são lidos em tempo real durante a execução do relatório.",
