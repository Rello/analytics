OC.L10N.register(
    ...
    "Formula" : "Fórmula",
    "Example: (30 * column1) + (column2 * -1)" : "Exemplo: (30 * coluna1) + (coluna2 * -1)",
    "Use column1, column2, fixed numbers, +, -, *, /, parentheses, and ROUND(value, decimals)." : "Use coluna1, coluna2, números fixos, +, -, *, /, parênteses, e ROUND(valor, casas decimais).",
