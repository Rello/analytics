OC.L10N.register(
    ...
    "Default sorting can be set for each dimension." : "A ordenação padrão pode ser definida para cada dimensão.",
    ...
    "Limit" : "Limite",
    "Filter release assets via extension" : "Filtrar ativos de liberação por meio de extensão",
    ...
    "Adjust drill-down views by removing columns effortlessly" : "Ajuste as visualizações detalhadas removendo colunas sem esforço",
    ...
    "Perform full or incremental delta loads" : "Executar cargas delta completas ou incrementais",
    "Schedule automatic data loads in the background" : "Agende cargas automáticas de dados em segundo plano",
    "Trigger data loads with scripts using the occ command" : "Acionar carregamentos de dados com scripts usando o comando occ",
