OC.L10N.register(
    ...
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Este relatório não possui carregamentos de dados.<br>Escolha uma fonte de dados no menu suspenso e pressione \"+\"",
    ...
    "To get started, create your first report" : "Para começar, crie seu primeiro relatório",
    ...
    "New Report" : "Novo relatório",
    "Create a report with the wizard" : "Criar um relatório com o assistente",
    "Intro" : "Introdução",
    "See the introduction again" : "Veja a introdução novamente",
    "Wiki" : "Wiki",
    "Find more information in the Wiki" : "Encontre mais informações no Wiki",
    ...
    "Selection" : "Seleção",
    "No data load created yet" : "Nenhum carregamento de dados criado ainda",
    ...
    "Advanced configuration - Data loads" : "Configuração avançada - Carregamentos de dados",
