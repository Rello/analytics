OC.L10N.register(
    ...
    "Failed to load dataset" : "Theip ar luchtú an tacair sonraí",
    ...
    "Column name" : "Ainm an cholúin",
    "Dimension" : "Toise",
    "Measure" : "Tomhais",
    "Nullable" : "In-nullaithe",
    "Move up" : "Bog suas",
    "Move down" : "Bog síos",
    "Remove" : "Bain",
    "Every column needs a name" : "Teastaíonn ainm ó gach colún.",
    "At least one dimension column is required" : "Teastaíonn colún toisí amháin ar a laghad.",
    "Date" : "Dáta",
    "Region" : "Réigiún",
    ...
    "Failed to create dataset" : "Theip ar chruthú an tacair sonraí",
    "Done" : "Déanta",
    "Failed to save dataset" : "Theip ar shábháil an tacair sonraí",
    "equal to" : "cothrom le",
    ...
    "Move {column} up" : "Bog {column} suas",
    "Remove {column}" : "Bain {column}",
    "Show {values}, with one series per {category} row." : "Taispeáin {values}, le sraith amháin in aghaidh gach sraithe {category}.",
    "Show {values} over time using {category}." : "Taispeáin {values} thar am ag baint úsáide as {category}.",
    "Show {values} by {category}, broken down by {series}." : "Taispeáin {values} de réir {category}, miondealaithe de réir {series}.",
    "Show {values} by {category}." : "Taispeáin {values} de réir {category}.",
    "Chart mapping preview" : "Réamhamharc ar mhapáil cairte",
    "Select at least one value for the chart" : "Roghnaigh luach amháin ar a laghad don chairt.",
    "Preview: {shown} of {total} report rows. Current filters apply." : "Réamhamharc: {shown} as {total} líne tuairisce. Tá na scagairí reatha i bhfeidhm.",
    "No data to preview with the current filters." : "Níl aon sonraí le réamhamharc a dhéanamh orthu leis na scagairí reatha.",
    "The preview shows a limited selection of categories and series. Report values are used without additional aggregation." : "Taispeánann an réamhamharc rogha theoranta de chatagóirí agus de shraitheanna. Úsáidtear luachanna na tuarascála gan comhiomlánú breise.",
    "This mapping cannot be previewed. Check the selected fields and data format." : "Ní féidir réamhamharc a fháil ar an mapáil seo. Seiceáil na réimsí roghnaithe agus an fhormáid sonraí.",
    "Time / X-axis" : "Am / Ais X",
    "Series label column" : "Colún lipéid na sraithe",
    "Category / X-axis" : "Catagóir / Ais X",
    "Value columns / X-axis" : "Colúin luacha / Ais X",
    "Values / Y-axis" : "Luachanna / Ais Y",
    "Automatic chart mapping" : "Mapáil chairt uathoibríoch",
    "Custom mapping" : "Mapáil shaincheaptha",
    "Add value…" : "Cuir luach leis…",
    "Add breakdown…" : "Cuir miondealú leis…",
    "None — add breakdown…" : "Dada — cuir miondealú leis…",
    ...
    "Source mapping" : "Mapáil foinse",
    "Run a test load or enter a source header to configure the mapping." : "Rith lucht tástála nó cuir isteach ceanntásc foinse chun an mapáil a chumrú.",
    "Not mapped" : "Gan a bheith mapáilte",
    "Ignored source columns" : "Colúin fho-fhoinse neamhaird orthu",
    ...
    "Choose a report" : "Roghnaigh tuarascáil",
    "The selected picture is not available" : "Níl an pictiúr roghnaithe ar fáil",
    "Select layout" : "Roghnaigh leagan amach",
    ...
    "Download" : "Íoslódáil",
    "Wait for all reports to load successfully before exporting." : "Fan go mbeidh gach tuairisc luchtaithe go rathúil sula ndéantar iad a easpórtáil.",
    ...
    "Could not save panorama. Check the filter mappings and try again." : "Níorbh fhéidir an panorama a shábháil. Seiceáil na mapálacha scagaire agus déan iarracht arís.",
    "No data" : "Gan sonraí",
    "Remove filter" : "Bain an scagaire",
    "Report" : "Tuairisc",
    "Reset" : "Athshocraigh",
    "Configure filters" : "Cumraigh scagairí",
    "Some report dimensions could not be loaded. Reopen this dialog to retry." : "Níorbh fhéidir toisí áirithe tuairisce a luchtú. Oscail an bosca dialóige seo arís chun triail eile a bhaint as.",
    "Enabled" : "Cumasaithe",
    "New variable" : "Athróg nua",
    "Variable name" : "Ainm athróg",
    "Default value" : "Luach réamhshocraithe",
    "Applies to" : "Baineann le",
    "Missing or changed dimension" : "Toise atá ar iarraidh nó athraithe",
    "Selected" : "Roghnaithe",
    "Add variable" : "Cuir athróg leis",
    "Apply" : "Cuir isteach",
    "Enter a name and repair missing dimensions. Enabled variables need a report dimension." : "Cuir ainm isteach agus déan na toisí atá ar iarraidh a dheisiú. Teastaíonn toise tuairiscithe ó athróga atá cumasaithe.",
    "A dimension can only belong to one enabled variable" : "Ní féidir le toise a bheith ina cuid ach d'athróg amháin atá cumasaithe.",
    "Enable the variables viewers may use. Match dimensions below, then save the panorama. Date expressions such as %last2months% are supported." : "Cumasaigh na hathróga a d’fhéadfadh breathnóirí a úsáid. Meaitseáil na toisí thíos, agus sábháil an panorama ansin. Tacaítear le habairtí dáta ar nós %last2months%.",
    ...
    "Failed to load report" : "Theip ar luchtú na tuairisce",
    "Flexible dataset · All {count} columns are included in the report." : "Tacar sonraí solúbtha · Tá na colúin uile {count} san áireamh sa tuarascáil.",
    ...
    "All dimension values together identify a record. Saving the same combination updates its measures." : "Aithníonn na luachanna toisí go léir le chéile taifead. Má shábháiltear an teaglaim chéanna, déantar a chuid tomhas a nuashonrú.",
    "No value" : "Gan luach",
    "Yes" : "Tá",
    "No" : "Níl",
    "Cancel edit" : "Cealaigh eagarthóireacht",
    "Save data" : "Sábháil sonraí",
    "Source header" : "Ceannteideal foinse",
    "Date, Region, Revenue" : "Dáta, Réigiún, Ioncam",
    "Delimiter" : "Deighilteoir",
    "Comma" : "Camóg",
    "Semicolon" : "Leathstad",
    "Tab" : "Táb",
    "First clipboard row is the header" : "Is é an chéad ró sa ghearrthaisce an ceanntásc.",
    ...
    "Failed to save data" : "Theip ar shábháil sonraí",
    "Failed to load records" : "Teip ar luchtú na dtaifead",
    "Edit" : "Cuir in eagar",
    "Delete data" : "Scrios sonraí",
    "Failed to delete data" : "Theip ar scriosadh sonraí",
    "Records to be deleted:" : "Taifid le scriosadh:",
    "Failed to import data" : "Theip ar shonraí a iompórtáil",
    ...
    "Visible columns" : "Colúin infheicthe",
    "Rows" : "Sraitheanna",
    "Select at least one visible column." : "Roghnaigh colún infheicthe amháin ar a laghad.",
    "Select exactly one field each in Rows, Columns, and Values." : "Roghnaigh réimse amháin go díreach i ngach ceann de na catagóirí seo a leanas: Sraitheanna, Colúin agus Luachanna.",
    "Several report rows map to the same pivot cell. Aggregate or filter the report first." : "Déantar roinnt sraitheanna tuairisce a mhapáil chuig an gcill pivot chéanna. Déan an tuairisc a chomhiomlánú nó a scagadh ar dtús.",
    "Check the column settings." : "Seiceáil socruithe na gcolún.",
    "Preview: {shown} of {total} table rows. Current report filters apply." : "Réamhamharc: {shown} as {total} ró tábla. Tá scagairí na tuairisce reatha i bhfeidhm.",
    "This table cannot be previewed. Check the layout and column settings." : "Ní féidir réamhamharc a fháil ar an tábla seo. Seiceáil an leagan amach agus socruithe na gcolún.",
    "Fractional values are displayed as percentages: 0.25 becomes 25%. Calculated percentages keep their existing scale." : "Taispeántar luachanna codánacha mar chéatadáin: déantar 0.25 de 25%. Coinníonn céatadáin ríofa a scála reatha.",
    ...
    "{label} Aggregation" : "{label} Comhiomlánú",
    "{label} Disaggregation" : "{label} Dí-chomhiomlánú",
    "others" : "daoine eile",
    ...
    "Link" : "Nasc",
    "Chart and table" : "Cairt agus tábla",
    "Chart only" : "Cairt amháin",
    "Table only" : "Bord amháin",
    "Content" : "Ábhar",
    ...
    "All dimension columns together identify a record. Renaming or reordering a column does not change its stable reference." : "Aithníonn na colúin toisí go léir le chéile taifead. Ní athraíonn athainmniú nó athordú colúin a thagairt sheasmhach.",
    "Add nullable measure" : "Cuir beart neamhní leis",
    ...
    "Layout" : "Leagan Amach",
    "Choose visible columns or arrange fields as a pivot table." : "Roghnaigh colúin le taispeáint nó socraigh réimsí mar thábla pivot.",
    "Choose and order visible columns" : "Roghnaigh agus socraigh na colúin infheicthe",
    "Pivot table" : "Tábla pivot",
    "Arrange one field each in Rows, Columns, and Values" : "Socraigh réimse amháin an ceann i Sraitheanna, i gColúin agus i Luachanna.",
    "Columns" : "Colúin",
    "Values" : "Luachanna",
    "Hidden columns" : "Colúin fholaithe",
    ...
    "Currency" : "Airgeadra",
    "Percent" : "Céatadán",
    "Decimal places" : "Ionaid dheachúlacha",
    "0" : "0",
    "1" : "1",
    "2" : "2",
    "3" : "3",
    ...
    "Center" : "Lár",
    "Right" : "Ar dheis",
    "Width (pixels)" : "Leithead (picteilíní)",
    "Wrap text" : "Fill téacs",
    "Reset column" : "Athshocraigh an colún",
    ...
    "Appearance" : "Dealramh",
    "Row spacing" : "Spásáil idir na sraitheanna",
    "Comfortable" : "Compordach",
    "Compact" : "Dlúth",
    "Show column headers" : "Taispeáin ceanntásca na gcolún",
    "Alternating row shading" : "Scáthú ailtéarnach ar shraitheanna",
    "Rows per page" : "Sraitheanna in aghaidh an leathanaigh",
    "10" : "10",
    "25" : "25",
    "50" : "50",
    "100" : "100",
    "Show totals" : "Taispeáin iomláin",
    "Format numbers and dates in local format" : "Formáidigh uimhreacha agus dátaí sa fhormáid áitiúil",
    "Compact visualization" : "Amharcléiriú dlúth",
    "Highlighting" : "Aibhsiú",
    "Highlight values below a limit with a background and downward marker. Existing report thresholds also apply." : "Aibhsigh luachanna atá faoi bhun teorann trí úsáid a bhaint as cúlra agus marc a dhíríonn síos. Baineann tairseacha tuairiscithe atá ann cheana féin leis seo freisin.",
    "Values below" : "Luachanna thíos",
    "Disabled" : "Faoi mhíchumas",
    "Live preview" : "Réamhamharc beo",
    "Select a column heading to format it. Totals use all loaded report rows, before the preview is limited." : "Roghnaigh ceannteideal colúin chun é a fhormáidiú. Úsáideann na suimeanna iomlána gach ró tuairisce atá luchtaithe, sula gcuirtear teorainn leis an réamhamharc.",
    ...
    "Data mapping" : "Mapáil sonraí",
    "Suggest mapping" : "Mol mapáil",
    "Break down by" : "Miondealú de réir",
    "Swap" : "Malartú",
    "Optional. One series for each distinct group." : "Roghnach. Sraith amháin do gach grúpa ar leith.",
    "Labels" : "Lipéid",
    ...
    "Create" : "Cruthaigh",
    "Dataset structure" : "Struchtúr an tacair sonraí",
    "Classic three-column dataset" : "Tacar sonraí clasaiceach trí cholún",
    "Flexible dataset" : "Tacar sonraí solúbtha",
    "All dimension columns together identify a record. Importing the same combination updates its measures." : "Aithníonn na colúin toisí go léir le chéile taifead. Má dhéantar an teaglaim chéanna a iompórtáil, déantar a chuid tomhas a nuashonrú.",
