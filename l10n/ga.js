OC.L10N.register(
    ...
    "You deleted report {report}" : "Scrios tú an tuairisc {report}",
    "You shared report {report}" : "Roinn tú tuairisc {report}",
    "shared report {report} with you" : "tuairisc roinnte {report} leat",
    ...
    "External file" : "Comhad seachtrach",
    ...
    "The EasyPrivacy list is blocking some scripts because of a wildcard '*analytics*' string filter." : "Tá an liosta EasyPrivacy ag cur bac ar roinnt scripteanna mar gheall ar scagaire teaghrán saoróg '*analytics*'.",
