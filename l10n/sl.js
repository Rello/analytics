OC.L10N.register(
    ...
    "Data" : "Podatki",
    "Dataload" : "Podatkovni nabor",
    "Data maintenance is not possible for this type of report" : "Pri tovrstnih poročilih urejanje podatkov ni mogoče",
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "V poročilo ni vključen noben podatkovni nabor. <br>Izberite ustrezno iz spustnega menija in pritisnite » + «.",
    "Choose a dataload from the list to change its settings" : "Izberite podatkovni nabor s seznama za spreminjanje nastavitev",
    "Saved" : "Shranjeno",
    "Are you sure?" : "Ali ste prepričani?",
    "Delete dataload" : "Izbriši podatkovni nabor",
    "Select file" : "Izbor datotek",
    "Datasource simulation" : "Simulacija podatkovnega vira",
    "Load started" : "Nalaganje podatkov je začeto",
    "records inserted" : "vstavljeni zapisi",
    "records updated" : "posodobljeni zapisi",
    "errors" : "napake",
    "No maintenance possible" : "Upravljanje ni mogoče",
    ...
    "Search" : "Poišči",
    "Show _MENU_ entries" : "Pokaži vnose _menija_",
    ...
    "Scheduled dataload" : "Načrtovano zbiranje nabora podatkov",
    ...
    "Reports can be grouped into a folder structure" : "Poročila je mogoče shranjevati v strukturo map",
    ...
    "Detail instructions at:" : "Podrobna navodila so na:",
    "REST API parameters" : "Parametri vmesnika API REST",
    "No shares found" : "Ni najdenih mest souporabe",
    ...
    "New data has been added to dataset {report} via dataload" : "Novi podatki so dodani v podatkovno množico {report} iz pripravljenega podatkovnega nabora.",
    ...
    "Limit" : "Omejitve",
    "Timestamp of dataload" : "Časovni žig podatkovnega nabora",
    "false/true" : "napak/prav",
    "JSON" : "JSON",
    "Authentication" : "Overitev",
    "Object path" : "Pot predmeta",
    "HTTP method" : "Način HTTP",
    "true/false" : "prav/napak",
    ...
    "Analytics - Advanced configuration" : "Analitika – napredne nastavitve",
    "This section is used for dataset maintenance and dataload configurations" : "Ta odsek se uporablja za upravljanje podatkovne množice in nastavitve podatkovnih naborov.",
    ...
    "10 min" : "10 min",
    "30 min" : "30 min",
    "New Report Wizard" : "Čarovnik za novo poročilo",
    "Choose a name for the report" : "Izbor imena poročila",
    "Subheader" : "Podnaslov",
    "Datasource" : "Podatkovni vir",
    "Saved Data" : "Shranjeni podatki",
    "Datasource options" : "Možnosti podatkovnega vira",
    ...
    "Realtime Data" : "Podatki v živo",
    "Stored Data" : "Shranjeni podatki",
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Za poročila je mogoče podatke pridobivati v živo s podatkovnimi viri, ali pa iz shranjenih podatkovnih množic znotraj okolja Nextcloud.",
    "Different data sources are available. The data is read in realtime when the report is being executed." : "Na voljo so različni podatkovni viri. Podatke je mogoče pridobivati v realnem času ob pripravi poročila",
    "Every datasource requires specific parameter. Please enter the information." : "Vsak podatkovni vir zahteva posebne parametre. Podatki morajo biti vpisani.",
