OC.L10N.register(
    ...
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "V poročilo ni vključena nobena podatkovna množica. <br>Izberite ustrezno iz spustnega menija in pritisnite » + «.",
    ...
    "Data series" : "Podatkovni niz",
    "Vertical axis" : "Navpična os",
    "Chart type" : "Vrsta diagrama",
    "Color" : "Barva",
    "New dataset" : "Nova podatkovna zbirka",
    "New report" : "Novo poročilo",
    "Dataset maintenance" : "Upravljanje podatkovne zbirke",
    "Back to reports" : "Nazaj na poročila",
    "Overview" : "Splošni pregled",
    "Scheduled dataload" : "Načrtovano zbiranje podatkov",
    ...
    "Datasets can be changed in a separate maintenance" : "Podatkovne zbirke je mogoče spreminjati ločeno med nastavljanjem.",
    "Switch to the dataset maintenance from here?" : "Ali želite preklopiti na urejanje podatkovne zbirke?",
    "New" : "Novo",
    ...
    "You have added new data to dataset {report}" : "Dodate nove podatke v podatkovno zbirko {report}",
    "You have imported data in dataset {report}" : "Uvozite podatke v podatkovno zbirko {report}",
    ...
    "Please select a dataset" : "Izbrati je treba podatkovno zbirko",
    "Options" : "Možnosti",
    "Analysis" : "Analiza",
    ...
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Za poročila je mogoče podatke pridobivati v živo s podatkovnimi viri, ali pa iz shranjenih podatkovnih zbirk znotraj okolja Nextcloud.",
    "Existing dataset" : "Obstoječa podatkovna zbirka",
    "The report can be based on a new dataset or read existing data that is available already." : "osnova poročila je lahko nova podatkovna zbirka oziroma že pripravljeni podatki.",
    "Datasets can store data from scheduled data loads, the REST API or manual data entry. This can be configured via the Dataset maintenance" : "Vir podatkov za podatkovne zbirke so lahko načrtovani nabori, lahko je vir določen za vmesnika API REST, podatki so lahko vpisani tudi ročno. Te možnosti je mogoče prilagajati med nastavitvami posamezne zbirke.",
    "Choose the names of the columns for the new dataset" : "Izbor imen stolpcev nove podatkovne zbirke",
