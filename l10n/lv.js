OC.L10N.register(
    ...
    "Delete" : "Dzēst",
    "All data including all reports will be deleted!" : "Visi dati ar visām atskaitēm tiks izdzēsti!",
    ...
    "Save to selected folder" : "Saglabāt izvēlētajā mapē",
    ...
    "Do you want to create a new group folder?" : "Vai Jūs vēlaties izveidot jaunu grupu mapi?",
    "New" : "Jauns",
    ...
    "Type" : "Veids",
    "Thresholds can be used to highlight data. Using the notification threshold, push messages are being sent." : "Sliksņi var tikt izmantoti, lai izdalīt datus. Izmantojot paziņojumu slieksni, push ziņojumi tiks nosūtīti.",
    "Threshold" : "Slieksnis",
    ...
    "Analytics" : "Analītika",
    "You created a new report: {report}" : "Jūs izveidojāt jaunu atskaiti: {report}",
    "Total" : "Kopā",
    "Yes" : "Jā",
    "No" : "Nē",
