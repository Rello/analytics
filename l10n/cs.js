OC.L10N.register(
    ...
    "Filter" : "Filtr",
    "Dynamic text variables can be used to select dates.<br>The selection is written between two % (e.g. %last2months%).<br>Information on available filters and alternative date formats is available in the {linkstart}Wiki{linkend}." : "K výběru dat je možné použít dynamické textové proměnné.<br>Výběr se píše mezi znaky % (např. %last2months%).<br>Informace o dostupných filtrech a alternativních formátech dat jsou k dispozici na {linkstart}Wiki{linkend}.",
    ...
    "Time grouping" : "Seskupování podle času",
    "summation" : "sumarizace",
    "average" : "průměr",
    "Group time values to day, week, month or year. Values will be aggregated accordingly." : "Seskupujte časové hodnoty v rámci dne, týdne, měsíce či roku. Hodnoty budou příslušně agregovány.",
    "Table options" : "Možnosti tabulky",
    "The table can be customized by positioning the rows and columns. <br>If a classic list view is required, all fields need to be placed in the rows section." : "Tabulku je možné přizpůsobovat změnou pozic řádků a sloupců. <br>Pokud je zapotřebí pohledu v klasickém seznamu, je třeba aby veškeré kolonky byly umístěny v sekci řádků.",
    "Sort" : "Seřadit",
    "Default" : "Výchozí",
    "Ascending" : "Vzestupně",
    "Descending" : "Sestupně",
    ...
    "No dataset yet" : "Zatím žádná databáze",
    ...
    "Adjust drill-down views by removing columns effortlessly" : "Přizpůsobte si konkrétní pohledy snadným odebíráním sloupců",
