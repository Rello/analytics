OC.L10N.register(
    ...
    "Realtime Data" : "Data v reálném čase",
    "Stored Data" : "Uložená data",
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Výkazy mohou svá dat číst buď ze zdrojů dat v reálném čase nebo z uložených souborů dat, uložených v databázi s Nextcloud.",
    "Different data sources are available. The data is read in realtime when the report is being executed." : "Jsou k dispozici různé zdroje dat. Když je výkaz vykonáván, jsou data načítána v reálném čase.",
