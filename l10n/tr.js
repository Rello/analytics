OC.L10N.register(
    ...
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Bu rapor için herhangi bir veri yüklemesi yok.<br>Açılan listeden bir veri kaynağı seçip \"+\" üzerine tıklayın",
    ...
    "To get started, create your first report" : "Başlamak için ilk raporunuzu hazırlayın",
    ...
    "New Report" : "Yeni rapor",
    "Create a report with the wizard" : "Yardımcı ile bir rapor hazırlayın",
    "Intro" : "Tanıtım",
    "See the introduction again" : "Tanıtımı yeniden görüntüle",
    "Wiki" : "Wiki",
    "Find more information in the Wiki" : "Wiki sayfaısndan ayrıntılı bilgi alın",
    ...
    "Share chart for external website" : "Dış web sitesi için çizelge paylaşımı",
    "To including a chart in an external website, that domain needs to be allowed (CSP policy)" : "Dışarıdaki bir web sitesine bir çizelge eklemek için bu etki alanına izin verilmelidir (CSP ilkesi)",
    "Copy link" : "Bağlantıyı kopyala",
    "Domain of external site" : "Dış web sitesinin etki alanı",
    ...
    "Advanced configuration - Data loads" : "Gelişmiş yapılandırma - Veri yüklemesi",
