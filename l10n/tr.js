OC.L10N.register(
    ...
    "Show in Analytics" : "İstatistiklerde görüntülensin",
    ...
    "<strong>Analytics</strong>: New data was added to a report" : "<strong>İstatistikler</strong>: Rapora yeni veriler eklendi",
    "<strong>Analytics</strong>: New reports" : "<strong>İstatistikler</strong>: Yeni raporlar",
    "Reports" : "Raporlar",
    ...
    "Analytics - Advanced configuration" : "İstatistikler - Gelişmiş yapılandırma",
    ...
    "Realtime Data" : "Gerçek zamanlı veriler",
    "Stored Data" : "Kaydedilmiş veriler",
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Raporlar, verilerini gerçek zamanlı veri kaynaklarından veya Nextcloud veritabanındaki kayıtlı veri kümelerinden okuyabilir.",
    "Different data sources are available. The data is read in realtime when the report is being executed." : "Farklı veri kaynakları kullanılabilir. Rapor hazırlanırken veriler gerçek zamanlı olarak okunur.",
