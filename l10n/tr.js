OC.L10N.register(
    ...
    "Dataset" : "Veri kümesi",
    "Data" : "Veriler",
    "Dataload" : "Veri yükleme",
    "Data maintenance is not possible for this type of report" : "Bu rapor türü için veri bakımı yapılamaz",
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "Bu rapor için herhangi bir veri yüklemesi yok.<br>Açılan listeden bir veri kaynağı seçip \"+\" üzerine tıklayın",
    "Choose a dataload from the list to change its settings" : "Listeden ayarlarını değiştirmek istediğiniz veri yüklemesini seçin",
    "Saved" : "Kaydedildi",
    "Are you sure?" : "Emin misiniz?",
    "Delete dataload" : "Veri yüklemesini sil",
    "Select file" : "Dosyayı seç",
    "Datasource simulation" : "Veri kaynağı benzetimi",
    "Load started" : "Yükleme başlatıldı",
    "records inserted" : "kayıt eklendi",
    "records updated" : "kayıt güncellendi",
    "errors" : "hatalı",
    "No maintenance possible" : "Yapılabilecek bir bakım yok",
    ...
    "Overview" : "Özet",
    "Scheduled dataload" : "Zamanlanmış veri yükleme",
    "Basic settings" : "Temel ayarlar",
    "Remove from favorites" : "Beğenilenlerden çıkar",
    "Add to favorites" : "Beğenilenlere ekle",
    ...
    "Column descriptions are derived from the dataset and can not be changed on a report level" : "Sütun açıklamaları veri kümesinden alınır ve rapor düzeyinde değiştirilemez",
    ...
    "No shares found" : "Herhangi bir paylaşım bulunamadı",
    ...
    "Real-time CSV data from GitHub via the *External URL*" : "\\\"Extrernal URL\\ üzerinden gerçek zamanlı GitHub CSV verileri",
    ...
    "New data has been added to dataset {report} via dataload" : "{report} veri kümesine veri yükleme ile yeni veriler eklendi",
    ...
    "Limit" : "Sınır",
    "Timestamp of dataload" : "Veri yükleme zaman damgası",
    ...
    "Analytics - Advanced configuration" : "Analytics - Gelişmiş yapılandırma",
    "This section is used for dataset maintenance and dataload configurations" : "Veri kümesi bakımı ve veri yükleme yapılandırmaları bu bölümden yapılabilir",
    ...
    "back" : "geri",
    "Aggregate values (beta)" : "Değer birleştirme (beta)",
    "Disaggregate values (beta)" : "Değer ayırma (beta)",
    "Linear Regression" : "Doğrusal regresyon",
    "1 min" : "1 dakika",
    "10 min" : "10 dakika",
    "30 min" : "30 dakika",
    "New Report Wizard" : "Yeni rapor yardımcısı",
    "Choose a name for the report" : "Rapor için bir ad belirleyin",
    "Subheader" : "Alt başlık",
    "Datasource" : "Veri kaynağı",
    "Saved Data" : "Kaydedilmiş veriler",
    "Datasource options" : "Veri kaynağı seçenekleri",
    ...
    "Data is processed inside Nextcloud" : "Veriler Nextcloud içinde korunur",
    ...
    "Internal data is persisted in the database and delivers the most flexibility and performance" : "İç veriler veritabanında tutulur ve en iyi esneklik ile başarımı sunar",
    ...
    "With the HTML-Grabber, almost any website data can be extracted" : "HTML-Grabber ile hemen hemen tüm web sitesi verilerini ayıklayın",
    ...
    "Advanced configuration: Data loads" : "Gelişmiş yapılandırma: Veri yükleri",
    ...
    "Schedule data loads in the background daily or hourly" : "Veri yüklerini arka planda günlük veya saatlik olarak zamanlayın",
    "Trigger data loads via scripts using the occ command" : "occ komutuyla betikler kullanarak veri yüklerini tetikleyin",
    ...
    "Reports can read their data either from real-time data sources or from saved datasets within the Nextcloud database." : "Raporlar, verilerini gerçek zamanlı veri kaynaklarından veya Nextcloud veritabanındaki kayıtlı veri kümelerinden okuyabilir.",
    ...
    "Every datasource requires specific parameter. Please enter the information." : "Her veri kaynağı için belirli bir parametre gerekir. Lütfen bilgileri yazın.",
