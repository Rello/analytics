OC.L10N.register(
    ...
    "Failed to load dataset" : "Veri kümesi yüklenemedi",
    ...
    "Remove" : "Kaldır",
    "Every column needs a name" : "Her sütunun bir adı olmalıdır",
    "At least one dimension column is required" : "En az bir boyut sütununun olması zorunludur",
    "Date" : "Tarih",
    "Region" : "Bölge",
    ...
    "Failed to create dataset" : "Veri kümesi oluşturulamadı",
    "Done" : "Tamam",
    "Failed to save dataset" : "Veri kümesi kaydedilemedi",
    ...
    "Move {column} up" : "{column} sütununu yukarı taşı",
    "Remove {column}" : "{column} sütununu kaldır",
    "Show {values}, with one series per {category} row." : "{values} değerlerini, her {category} satırı için bir dizi olarak görüntüle.",
    "Show {values} over time using {category}." : "{values} değerlerini {category} kategorisi ile zamana göre görüntüle.",
    "Show {values} by {category}, broken down by {series}." : "{values} değerlerini, {category} kategorisine göre {series} kırılımı ile görüntüle.",
    "Show {values} by {category}." : "{values} değerlerini {category} kategorisine göre görüntüle.",
    "Chart mapping preview" : "Çizelge eşleştirme ön izlemesi",
    "Select at least one value for the chart" : "Çizelgeden en az bir değer seçin",
    "Preview: {shown} of {total} report rows. Current filters apply." : "Ön izleme: {shown} / {total} rapor satırı. Geçerli süzgeçler uygulanıyor.",
    "No data to preview with the current filters." : "Geçerli süzgeçler ön izleme için bir veri döndürmüyor.",
    "The preview shows a limited selection of categories and series. Report values are used without additional aggregation." : "Ön izlemede, sınırlı sayıda kategori ve dizi görüntülenir. Rapor değerleri ek toplama olmadan kullanılır.",
    "This mapping cannot be previewed. Check the selected fields and data format." : "Bu eştirmenin ön izlemesi görüntülenemiyor. Seçilmiş alanları ve veri biçimini denetleyin.",
    "Time / X-axis" : "Zaman / X ekseni",
    "Series label column" : "Dizi etiketleri sütunu",
    "Category / X-axis" : "Kategori / X ekseni",
    "Value columns / X-axis" : "Değer sütunları / X ekseni",
    "Values / Y-axis" : "Değerler / Y ekseni",
    "Automatic chart mapping" : "Otomatik çizelge eşleştirme",
    "Custom mapping" : "Özel eşleştirme",
    "Add value…" : "Değer ekle…",
    "Add breakdown…" : "Kırılım ekle…",
    "None — add breakdown…" : "Yok — Kırılım ekle…",
    ...
    "Source mapping" : "Kaynak eşleştirme",
    "Run a test load or enter a source header to configure the mapping." : "Eşlemeyi yapılandırmak için bir deneme işlemi yapın ya da bir kaynak başlığı yazın.",
    "Not mapped" : "Eşleştirilmemiş",
    "Ignored source columns" : "Yok sayılan kaynak sütunları",
    ...
    "Download" : "İndir",
    "Wait for all reports to load successfully before exporting." : "Dışa aktarmadan önce tüm raporların yüklenmesini bekleyin.",
    ...
    "Could not save panorama. Check the filter mappings and try again." : "Manzara kaydedilemedi. Süzgeç eşlemelerini denetleyip yeniden deneyin.",
    "No data" : "Herhangi bir veri yok",
    "Remove filter" : "Süzgeci kaldır",
    "Report" : "Rapor",
    "Reset" : "Sıfırla",
    "Configure filters" : "Süzgeçleri yapılandır",
    "Some report dimensions could not be loaded. Reopen this dialog to retry." : "Bazı rapor boyutları yüklenemedi. Yeniden denemek için bu iletişim kutusunu yeniden açın.",
    "Enabled" : "Kullanılıyor",
    "New variable" : "Yeni değişken",
    "Variable name" : "Değişken adı",
    "Default value" : "Varsayılan değer",
    "Applies to" : "Şuna uygulanır",
    "Missing or changed dimension" : "Boyut eksik veya değiştirilmiş",
    "Selected" : "Seçilmiş",
    "Add variable" : "Değişken ekle",
    "Apply" : "Uygula",
    "Enter a name and repair missing dimensions. Enabled variables need a report dimension." : "Bir ad yazın ve eksik boyutları onarın. Etkin değişkenlerin bir rapor boyutu olmalıdır.",
    "A dimension can only belong to one enabled variable" : "Bir boyut yalnızca bir etkin değişkene ait olabilir",
    "Enable the variables viewers may use. Match dimensions below, then save the panorama. Date expressions such as %last2months% are supported." : "İzleyicilerin kullanabileceği değişkenleri etkinleştirin. Aşağıdaki boyutları eşleştirin, ardından manzarayı kaydedin. %Last2months% gibi tarih ifadeleri desteklenir.",
    ...
    "Flexible dataset · All {count} columns are included in the report." : "Esnek veri kümesi · {count} sütunun tümü rapora katılıyor.",
    ...
    "All dimension values together identify a record. Saving the same combination updates its measures." : "Tüm boyut değerleri birlikte bir kaydı tanımlar. Aynı kombinasyonu kaydetmek ölçümlerini günceller.",
    "No value" : "Değer yok",
    "Yes" : "Evet",
    "No" : "Hayıt",
    "Cancel edit" : "Düzenlemeyi iptal et",
    "Save data" : "Verileri kaydet",
    "Source header" : "Kaynak başlığı",
    "Date, Region, Revenue" : "Tarih, Bölge, Kâr",
    "Delimiter" : "Sınırlayıcı",
    "Comma" : "Virgül",
    "Semicolon" : "Noktalı virgül",
    "Tab" : "Sekme",
    "First clipboard row is the header" : "Panodaki ilk satır başlıktır",
    ...
    "Failed to load records" : "Kayıtlar yüklenemedi",
    "Edit" : "Düzenle",
    "Delete data" : "Verileri sil",
    "Failed to delete data" : "Veriler silinemedi",
    "Records to be deleted:" : "Silinecek kayıtlar:",
    "Failed to import data" : "Veriler içe aktarılamadı",
    ...
    "Rows" : "Satırlar",
    "Select at least one visible column." : "En az bir görünür sütun seçin.",
    "Select exactly one field each in Rows, Columns, and Values." : "Satırların, sütunların ve değerler için tam olarak bir alan seçin.",
    "Several report rows map to the same pivot cell. Aggregate or filter the report first." : "Birkaç rapor satırı aynı özet hücresi ile eşleşiyor. Önce raporu toplayın ya da süzün.",
    "Check the column settings." : "Sütun ayarlarını denetleyin.",
    "Preview: {shown} of {total} table rows. Current report filters apply." : "Ön izleme: {shown} / {total} tablo satırı. Geçerli rapor süzgeçleri uygulanıyor.",
    "This table cannot be previewed. Check the layout and column settings." : "Bu tablonun ön izlemesi görüntülenemiyor. Yerleşimi ve sütun ayarlarını denetleyin.",
    "Fractional values are displayed as percentages: 0.25 becomes 25%. Calculated percentages keep their existing scale." : "Kesirli değerler yüzde olarak görüntülenir: 0,25 %25 olur. Hesaplanan yüzdeler geçerli ölçeklerini korur.",
    ...
    "Segment" : "Dilim",
    "Year" : "Yıl",
    "Sales and revenue of the last years." : "Geçmiş yıllardaki satış ve kârlar.",
    "New in" : "Şurada yeni",
    ...
    "{label} Aggregation" : "{label} birleştirme",
    "{label} Disaggregation" : "{label} ayrıştırma",
    "others" : "diğerleri",
    "Analytics" : "Analytics",
    ...
    "Link" : "Bağlantı",
    "Chart and table" : "Çizelge ve tablo",
    "Chart only" : "Yalnızca çizelge",
    "Table only" : "Yalnızca tablo",
    "Content" : "İçerik",
    ...
    "All dimension columns together identify a record. Renaming or reordering a column does not change its stable reference." : "Tüm boyut sütunları birlikte bir kaydı tanımlar. Bir sütunu yeniden adlandırmak veya yeniden sıralamak, sabit başvuruyu değiştirmez.",
    "Add nullable measure" : "Null olabilen ölçü ekle",
    ...
    "Layout" : "Yerleşim",
    "Choose visible columns or arrange fields as a pivot table." : "Görünür sütunları seçin ya da alanları özet tablo olarak düzenleyin.",
    "Choose and order visible columns" : "Görünür sütunları seçin ve sıralayın",
    "Pivot table" : "Özet tablo",
    "Arrange one field each in Rows, Columns, and Values" : "Satırlar, Sütunlar ve Değerler bölümlerinden birer alan ayarlayın",
    "Columns" : "Sütunlar",
    "Values" : "Değerler",
    ...
    "Wrap text" : "Yazıyı kaydır",
    "Reset column" : "Sütunu sıfırla",
    ...
    "Appearance" : "Görünüm",
    "Row spacing" : "Satır boşluğu",
    "Comfortable" : "Geniş",
    "Compact" : "Dar",
    "Show column headers" : "Sütun başlıklarını görüntüle",
    "Alternating row shading" : "Değişken satır gölgelemesi",
    "Rows per page" : "Bir sayfadaki satır sayısı",
    "10" : "10",
    "25" : "25",
    "50" : "50",
    "100" : "100",
    ...
    "Values below" : "Şunun altındaki değerler",
    "Disabled" : "Kullanılmıyor",
    "Live preview" : "Canlı ön izleme",
    "Select a column heading to format it. Totals use all loaded report rows, before the preview is limited." : "Biçimlendirilecek bir sütun başlığı seçin. Toplamlar, ön izleme sınırlandırılmadan önce yüklenen tüm rapor satırlarını kullanır.",
    ...
    "Data series are organized by horizontal rows." : "Veri dizileri yatay satırlar olarak düzenlenir.",
    "In columns" : "Sütunlar biçiminde",
    "Data series are grouped by vertical columns." : "Veri dizileri dikey satırlar olarak düzenlenir.",
    "Timestamps" : "Zaman damgaları",
    "Use first column for time-series indexing." : "Zaman dizisi dizini olarak ilk sütun kullanılır.",
    "Data mapping" : "Veri eşleştirme",
    "Suggest mapping" : "Eşleştirme öner",
    "Break down by" : "Şuna göre kırılım",
    "Swap" : "Takas belleği",
    "Optional. One series for each distinct group." : "İsteğe bağlı. Her farklı grup için bir dizi.",
    "Labels" : "Etiketler",
    ...
    "Create" : "Oluştur",
    "Dataset structure" : "Veri kümesi yapısı",
    "Classic three-column dataset" : "Klasik üç sütunlu veri kümesi",
    "Flexible dataset" : "Esnek veri kümesi",
    "All dimension columns together identify a record. Importing the same combination updates its measures." : "Tüm sütun değerleri birlikte bir kaydı tanımlar. Aynı kombinasyonu içe aktarmak ölçümlerini günceller.",
