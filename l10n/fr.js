OC.L10N.register(
    ...
    "Add custom column" : "Ajouter une colonne personnalisé",
    "Select the required columns.<br>Rearrange the sequence with drag & drop.<br>Remove all selections to reset.<br>Add custom columns including text variables for dates. See the {linkstart}Wiki{linkend}." : "Sélectionnez les colonnes requises. <br>Réarranez la séquence avec un glisser-déposer.<br>Supprimer toutes les sélections pour réinitialiser.<br>Ajouter des colonnes personalisées incluant des variables texte pour les dates. Voir le {linkstart}Wiki{linkend}.",
    ...
    "Reset Table" : "Réinitialiser la table",
