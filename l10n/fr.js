OC.L10N.register(
    ...
    "Text variables can be used in the dimensions.<br>They are replaced when the data is added." : "Les variables texte peuvent utilisées dans les dimensions.<br>Elles sont remplacées lorsque les données sont ajoutées.",
