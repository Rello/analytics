OC.L10N.register(
    ...
    "Read file and add its data to an existing dataset" : "Lire le fichier et ajouter ses données à un jeu de données existant",
    ...
    "Use column index starting with 0" : "Utiliser un indice de colonne commençant par 0",
