OC.L10N.register(
    ...
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Ce rapport n'a pas de données chargées.<br>Choisissez une source de données dans la liste déroulante et pressez \"+\"",
    ...
    "errors" : "erreurs",
    "No maintenance possible" : "Aucune gestion possible",
    "This dataset is not used!" : "Cet jeu de données n'est pas utilisé!",
    "All data including all reports will be deleted!" : "Tous les rapports vont être supprimés!",
    "Delete" : "Supprimer",
    ...
    "Technical error. Please check the logs." : "Erreur technique. Merci de vérifier les logs.",
    "Search" : "Recherche",
    "Show _MENU_ entries" : "Afficher les entrées _MENU_",
    "Showing _START_ to _END_ of _TOTAL_ entries" : "Affichage des entrées _START_ to _END_ of _TOTAL_ ",
    ...
    "Dataset maintenance" : "Gestion des jeu de données",
    "No reports yet" : "Aucun rapport pour le moment",
    "Back to reports" : "Retour au rapports",
    ...
    "Text variables can be used in the name or subheader.<br>They are replaced when the report is executed." : "Des variables de texte peuvent être utilisées dans le nom ou le sous-en-tête. <br>Elles sont remplacées lors de l'exécution du rapport.",
    "Text variables" : "Variables texte",
    "Reports can be grouped into a folder structure." : "Les rapports peuvent être regroupés dans un dossier.",
    "Do you want to create a new group folder?" : "Voulez-vous créer un nouveau groupement de dossier ?",
    "Report group" : "Groupement de dossiers",
    "Column descriptions are derived from the dataset and can not be changed on a report level" : "Les descriptions de colonnes sont dérivées du jeu de données et ne peuvent pas être modifiées au niveau du rapport",
    ...
    "This was the last report on the dataset. Do you want to delete the dataset including all data?" : "Il s'agissait du dernier rapport sur l'ensemble de données. Voulez-vous supprimer l'ensemble de données, y compris toutes les données ?",
    ...
    "Demo: Analytics Downloads" : "Démo : Téléchargements Analytique",
    "Object" : "Objet",
    "Date" : "Date",
    ...
    "<strong>Analytics</strong>: New reports" : "<strong>Analytique</strong> : Nouveaux rapports",
    "Reports" : "Rapports",
    ...
    "HTML grabber" : "Téléchargeur HTML",
    ...
    "Analytics - Advanced configuration" : "Analytics - Configuration avancée",
    "This section is used for dataset maintenance and data load configurations." : "Cette section est utilisée pour la maintenance des ensembles de données et les configurations de chargement des données.",
    ...
    "Save as new report" : "Enregistrer en tant que nouveau rapport",
    "back" : "retour",
    "Aggregate values (beta)" : "Valeurs agrégées (bêta)",
    "Disaggregate values (beta)" : "Valeurs désagrégées (bêta)",
    ...
    "New Report Wizard" : "Assistant Nouveau Rapport",
    "Choose a name for the report" : "Choisir un nom pour le rapport",
    ...
    "Chart" : "Graphique",
    "Table" : "Tableau",
    "Timeline (date in column 2)" : "Chronologie (date dans la colonne 2)",
    "Area" : "Zone",
    "Doughnut" : "Camembert",
    "advanced" : "avancé",
    ...
    "Selection" : "Sélection",
    "No data load created yet" : "Aucun chargement de données créé pour le moment",
    "Setting" : "Paramètre",
    "Title" : "Titre",
    ...
    "Share your reports and insights" : "Partagez vos rapports et informations",
    "Fully integrated into Nextcloud" : "Entièrement intégré à Nextcloud",
    ...
    "Use different chart types per data series" : "Utiliser différents types de graphiques pour chaque série de données",
    "Save default filters" : "Sauver les filtres par défaut",
    "Use data from various data sources" : "Utiliser des données provenant de diverses sources de données",
    ...
    "Read data from internal Nextcloud files to visualize them in real-time" : "Lire les données des fichiers présent sur Nextcloud pour les visualiser en temps réel",
    "Advanced configuration - Data loads" : "Configuration avancée - Chargements de données",
    "Any data source can be persisted in Nextcloud" : "Toute source de données peut être conservée dans Nextcloud",
    "Use timestamps to historize data" : "Utiliser des horodatages pour historiser les données",
    "Full (deletion of old data) or delta loads" : "Chargements complets (suppression des anciennes données) ou du delta",
    "Schedule data loads in the background daily or hourly" : "Planifiez les chargements de données en arrière-plan quotidiennement ou toutes les heures",
    ...
    "Text variables can be used in the name or subheader. They are replaced when the report is executed." : "Des variables de texte peuvent être utilisées dans le nom ou le sous-en-tête. Ils sont remplacés lors de l'exécution du rapport.",
    ...
    "Stored Data" : "Données enregistrées",
    "Reports can read their data either from real-time data sources or from saved datasets within the Nextcloud database." : "Les rapports peuvent lire leurs données soit à partir de sources de données en temps réel, soit à partir d'ensembles de données enregistrés dans la base de données Nextcloud.",
    ...
    "Every data source requires specific parameter. Please enter the information." : "Chaque source de données nécessite un paramètre spécifique. Veuillez entrer les informations.",
