OC.L10N.register(
    ...
    "No reports yet" : "Aínda non hai informes",
    ...
    "At least one visualization selection is required" : "É necesaria polo menos unha selección de vista",
    ...
    "Add share link" : "Engadir ligazón compartida",
    ...
    "3rd field must be a valid number" : "O 3º campo debe ser un número válido",
    ...
    "Analytics" : "Analítica",
    "You created a new report: {report}" : "Vostede creou un novo informe: {report}",
    "You deleted report {report}" : "Vostede eliminou un informe: {report}",
    "You shared report {report}" : "Vostede compartiu un informe: {report}",
    "shared report {report} with you" : "compartiu o informe {report} con vostede",
    "You have added new data to dataset {report}" : "Vostede engadiu novos datos ao conxunto de datos {report}",
    "has added new data to dataset {report}" : "engadiu novos datos ao conxunto de datos {report}",
    "You have imported data in dataset {report}" : "Vostede importou datos ao conxunto de datos {report}",
    ...
    "External file" : "Ficheiro externo",
    ...
    "The EasyPrivacy list is blocking some scripts because of a wildcard '*analytics*' string filter." : "A lista EasyPrivacy está bloqueando algúns scripts por mor dun filtro de cadea comodín «*analytics*».",
    ...
    "Change drill down by removing columns" : "Cambie o detalle eliminando columnas",
    ...
    "Every data source requires specific parameter. Please enter the information." : "Cada orixe de datos necesita un parámetro específico. Introduza a información.",
