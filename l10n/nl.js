OC.L10N.register(
    ...
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Dit rapport heeft geen databelasting. <br>Kies een gegevensbron uit het dropdown-menu en druk op \"+\"",
    "Choose a data load from the list to change its settings" : "Kies een databelasting uit de lijst om de instellingen te veranderen",
    "Saved" : "Opgeslagen",
