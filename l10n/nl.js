OC.L10N.register(
    ...
    "Dataset" : "Dataset",
    "Data" : "Data",
    "Data load" : "Gegevensladen",
    "Data maintenance is not possible for this type of report" : "Dataonderhoud is niet mogelijk voor dit type rapport",
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Dit rapport heeft geen dataladingen. <br>Kies een gegevensbron uit het dropdown-menu en druk op \"+\"",
    "Choose a data load from the list to change its settings" : "Kies een datalading uit de lijst om de instellingen te veranderen",
    "Saved" : "Opgeslagen",
    "Are you sure?" : "Weet je het zeker?",
    "Delete data load" : "Verwijder datalading",
    ...
    "Selection" : "Selectie",
    "No data load created yet" : "Nog geen datalading gecreëerd",
    ...
    "Advanced configuration - Data loads" : "Geavanceerde instelling - Dataladingen",
