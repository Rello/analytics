OC.L10N.register(
    ...
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "Dit rapport heeft geen dataladingen. <br>Kies een databron uit de dropdown en druk op \"+\"",
    "Choose a dataload from the list to change its settings" : "Kies een datalading uit de lijst om de instellingen van te veranderen",
    "Saved" : "Opgeslagen",
    "Are you sure?" : "Weet je het zeker?",
    "Delete dataload" : "Verwijder datalading",
    "Select file" : "Selecteer bestanden",
    "Datasource simulation" : "Databron simulatie",
    "Load started" : "Laden gestart",
    "records inserted" : "waarden ingevoegd",
    "records updated" : "waarden geüpdatet",
    "errors" : "fouten",
    "No maintenance possible" : "Geen onderhoud mogelijk",
    ...
    "Overview" : "Overzicht",
    "Scheduled dataload" : "Geplande datalading",
    ...
    "Reports can be grouped into a folder structure" : "Rapporten kunnen gegroepeerd worden in een mapstructuur",
    "Do you want to create a new group folder?" : "Wil je een nieuwe groepsmap aanmaken?",
    "Report group" : "Rapporteer groep",
    "Column descriptions are derived from the dataset and can not be changed on a report level" : "Kolombeschrijvingen worden afgeleid uit de dataset en kunnen niet veranderd worden op rapportniveau",
    ...
    "Detail instructions at:" : "Gedetailleerde instructies op:",
    "REST API parameters" : "REST API parameters",
    "No shares found" : "Geen shares gevonden",
    "Add share link" : "Voeg deelling toe",
    ...
    "New data has been added to dataset {report} via dataload" : "Nieuwe data is toegevoegd aan dataset {report} via datalading",
    ...
    "Limit" : "Limiet",
    "Timestamp of dataload" : "Tijdstempel van datalading",
    "false/true" : "onwaar/waar",
    "JSON" : "JSON",
    ...
    "Analytics - Advanced configuration" : "Analytics - Geavanceerde configuratie",
    "This section is used for dataset maintenance and dataload configurations" : "Deze sectie wordt gebruikt voor datasetonderhoud en dataladingconfiguraties",
    ...
    "10 min" : "10 min",
    "30 min" : "30 min",
    "New Report Wizard" : "Nieuw Rapport Wizard",
    "Choose a name for the report" : "Kies een naam voor het rapport",
    "Subheader" : "Subkop",
    "Datasource" : "Databron",
    "Saved Data" : "Opgeslagen Data",
    "Datasource options" : "Databron opties",
    ...
    "Thresholds can trigger notifications and color coding in reports" : "Drempelwaarden kunnen meldingen en kleurcodering in rapporten triggeren",
    ...
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Rapporten kunnen ofwel hun data lezen uit realtime databronnen of van opgeslagen datasets in de Nextcloud database.",
    "Different data sources are available. The data is read in realtime when the report is being executed." : "Verschillende databronnen zijn beschikbaar. De data wordt gelezen in realtime wanneer het rapport wordt uitgevoerd.",
    "Every datasource requires specific parameter. Please enter the information." : "Elke databron vereist een specifieke parameter. Voer alsjeblieft de informatie in.",
