OC.L10N.register(
    ...
    "Analytics - Advanced configuration" : "Аналитика - Напредна конфигурација",
    ...
    "Advanced configuration - Data loads" : "Напредна конфигурација - Учитавања података",
