OC.L10N.register(
    ...
    "The EasyPrivacy list is blocking some scripts because of a wildcard '*analytics*' string filter." : "EasyPrivacy листа блокира неке скрипте због џокер стринг филтера ’*analytics*’.",
    ...
    "Switch Axis" : "Замени осе",
    "KPI model" : "KPI модел",
    "A list of values. This is the default layout" : "Листа вредности. Ово је подразумевани распоред",
    "Account model" : "Модел рачуна",
    "One line per topic with the numbers in the same line" : "Једна линија по теми са бројевима у истој линији",
