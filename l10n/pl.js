OC.L10N.register(
    ...
    "Overview" : "Przegląd",
    "Scheduled dataload" : "Zaplanowane wczytywanie danych",
    ...
    "Real-time CSV data from GitHub via the *External URL* datasource" : "Dane CSV w czasie rzeczywistym z GitHuba za pośrednictwem źródła danych *Zewnętrzny URL*",
    ...
    "New data has been added to dataset {report} via dataload" : "Nowe dane zostały dodane do zbioru danych {raport} poprzez wczytanie danych",
    ...
    "back" : "Wstecz",
    "Aggregate values (beta)" : "Wartości agregacji (beta)",
    "Disaggregate values (beta)" : "Wartości dezagregacji (beta)",
    ...
    "Advanced configuration: Data loads" : "Konfiguracja zaawansowana: Ładowanie danych",
    ...
    "Reports can read their data either from real-time data sources or from saved datasets within the Nextcloud database." : "Raporty mogą odczytywać swoje dane ze źródeł danych w czasie rzeczywistym lub z zapisanych zbirów danych w bazie danych Nextcloud.",
