OC.L10N.register(
    ...
    "At least one visualization selection is required" : "Mindest eine Visualisierung ist erforderlich",
    ...
    "You deleted report {report}" : "Du hast den Bericht {report} gelöscht",
    "You shared report {report}" : "Du hast den Bericht {report} geteilt",
    "shared report {report} with you" : "hat einen Bericht {report} mit Dir geteilt",
    ...
    "Choose a name for the report" : "Wähle einen Namen für den Bericht",
    ...
    "Thresholds can trigger notifications and color coding in reports" : "Schwellwerte können Benachrichtigungen und Farbkodierungen in Berichten auslösen",
    ...
    "Nextcloud Analytics makes your data visible and helps you to evaluate them - from financial data to IoT logs" : "Nextcloud Analytics macht Deine Daten sichtbar und unterstützt bei deren Analyse - von Finanzzahlen bis zu IoT Logs",
    "Give your numbers a meaning" : "Gebe Deinen Zahlen eine Bedeutung",
    ...
    "Activate a set of demo report to show how Analytics works" : "Aktiviere eine Reihe von Demo-Berichten, um zu sehen, wie Analytics funktioniert",
    ...
    "Every datasource requires specific parameter. Please enter the information." : "Jede Datenquelle benötigt spezifische Parameter. Bitte pflege die Informationen.",
