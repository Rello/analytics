OC.L10N.register(
    ...
    "Columns" : "Columnes",
    "Measures" : "Mesures",
    "Not required" : "No necessari",
    "Show totals" : "Mostra els totals",
    "Format all numbers in local format" : "Formateu tots els números en format local",
    ...
    "In rows" : "En files",
    "A list of values. This is the default." : "Una llista de valors. Aquesta és la predeterminada.",
    ...
    "Gain a comprehensive view of your data with Nextcloud Dashboard" : "Obteniu una visió completa de les vostres dades amb Nextcloud Dashboard",
    ...
    "Slice and dice your data with precision" : "Talleu les vostres dades amb precisió",
    "Apply flexible filters, including dynamic date variables" : "Apliqueu filtres flexibles, incloses les variables de data dinàmiques",
    "Adjust drill-down views by removing columns effortlessly" : "Ajusteu les vistes desglossades eliminant columnes sense esforç",
    ...
    "Save default filters for quick access to your preferred views" : "Deseu els filtres predeterminats per accedir ràpidament a les vostres visualitzacions preferides",
    ...
    "Monitor real-time download statistics with GitHub integration" : "Superviseu les estadístiques de descàrrega en temps real amb la integració de GitHub",
    "Leverage the JSON data source to pull data from external services" : "Aprofiteu la font de dades JSON per extreure dades de serveis externs",
    ...
    "Visualize data from internal Nextcloud applications instantly" : "Visualitzeu les dades de les aplicacions internes de Nextcloud a l'instant",
    ...
    "Utilize timestamps to create historical records" : "Utilitzeu segells de temps per crear registres històrics",
    "Perform full or incremental delta loads" : "Realitzeu càrregues delta completes o incrementals",
    "Schedule automatic data loads in the background" : "Programeu les càrregues automàtiques de dades en segon pla",
