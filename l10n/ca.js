OC.L10N.register(
    ...
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Aquest informe no té cap càrrega de dades.<br> Trieu una font de dades del menú desplegable i premeu \"+\"",
    "Choose a data load from the list to change its settings" : "Trieu una càrrega de dades de la llista per canviar-ne la configuració",
    "Saved" : "Desat",
    ...
    "errors" : "errors",
    "No maintenance possible" : "No es pot fer manteniment",
    ...
    "Add a report to the favorites to be shown here." : "Afegiu un informe als preferits per mostrar-lo aquí.",
    "equal to" : "igual a",
    ...
    "Overview" : "Resum",
    "Scheduled data load" : "Càrrega de dades programada",
    "Basic settings" : "Configuració bàsica",
    "Add to new group" : "Afegir a nou grup",
    ...
    "Thresholds" : "Llindars",
    "Share" : "Compartir",
    "All data will be deleted!" : "Totes les dades s'esborraran!",
    ...
    "At least one visualization selection is required" : "Es requereix almenys una selecció de visualització",
    ...
    "Detail instructions at:" : "Instruccions detallades a:",
    "REST API parameters" : "Paràmetres de l'API REST",
    "No shares found" : "No s'han trobat comparticions",
    "Add share link" : "Afegeix un enllaç per compartir",
    "Share link" : "Comparteix l'enllaç",
    "Link copied" : "Enllaç copiat",
    "Column 1" : "Columna 1",
    "Column 3" : "Columna 3",
    "Text variables can be used to evaluate a date value.<br>For example %today% can be used to highlight the data of today.<br>Operator and value are not relevant in this case." : "Les variables de text poden ser utiltzades per evaluar una valor de data.<br>Per exemple %to day% pot ser utilitzat per remarcar la data d'avui. <br> L'operador i el valor no són relevants en aquest cas. ",
    "new record" : "nou registre",
    "Missing data" : "Falten dades",
    "3rd field must be a valid number" : "El tercer camp ha de ser un número vàlid",
    ...
    "Object" : "Objecte",
    "Date" : "Data",
    "Real-time download statistics from GitHub." : "Estadístiques de descàrrega en temps real de GitHub.",
    ...
    "false/true" : "fals/cert",
    "Version" : "Versió",
    "Download count" : "Recompte de descàrregues",
    "JSON" : "JSON",
    ...
    "If you see this message, please disable AdBlock/uBlock for this domain (only)." : "Si veieu aquest missatge, desactiveu AdBlock/uBlock per a aquest domini (només).",
    ...
    "Analytics - Advanced configuration" : "Analítica - Configuració avançada",
    ...
    "Download chart" : "Descarrega el gràfic",
    ...
    "Others" : "Altres",
    "Notification for new records" : "Notificació per nous registres.",
    "Selection" : "Selecció",
    "No data load created yet" : "Encara no s'ha creat cap càrrega de dades",
    ...
    "Save default filters" : "Desa els filtres predeterminats",
    ...
    "Use data from GitHub to monitor download statistics in real-time" : "Utilitzeu dades de GitHub per controlar les estadístiques de descàrrega en temps real",
    ...
    "Advanced configuration - Data loads" : "Configuració avançada - Càrrega de dades",
    ...
    "Schedule data loads in the background daily or hourly" : "Planifiqeu les càrregues de dades en segon pla cada dia o cada hora",
    ...
    "You can open this introduction again by selecting \"Introduction\" in the Analytics settings section." : "Podeu tornar a obrir aquesta introducció seleccionant \"Introducció\" a la secció de configuració d'Analítica.",
    ...
    "Many reports can be based on the same data, but every report has its own visualization, threshold and sharing settings." : "Molts informes es poden basar en les mateixes dades, però cada informe té la seva pròpia configuració de visualització, llindar i compartició.",
    "Datasets can store data from scheduled data loads, the REST API or manual data entry. This can be configured via the Dataset maintenance" : "Els conjunts de dades poden emmagatzemar dades de càrregues de dades programades, l'API REST o l'entrada manual de dades. Això es pot configurar mitjançant el manteniment del conjunt de dades",
    ...
    "All settings can be changed afterwards" : "Totes les configuracions es poden canviar després",
