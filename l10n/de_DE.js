OC.L10N.register(
    ...
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "Dieser Bericht hat noch keine Datenladungen.<br>Bitte eine Datenquelle aus dem Dropdown auswählen und \"+\" drücken",
    ...
    "errors" : "Fehler",
    "No maintenance possible" : "Keine Wartung möglich",
    ...
    "Real-time CSV data from GitHub via the *External URL*" : "Echtzeit-CSV-Daten von GitHub über *External URL*",
    ...
    "New data has been added to dataset {report} via dataload" : "Neue Daten wurden dem Datensatz {report} per Datenladung hinzugefügt",
    ...
    "back" : "zurück",
    "Aggregate values (beta)" : "Werte aggregieren (Beta)",
    "Disaggregate values (beta)" : "Werte disaggregieren (Beta)",
    ...
    "Visualize any data with easy to use reports" : "Visualisieren Sie beliebige Daten mit benutzerfreundlichen Berichten",
    "Different chart types like lines, columns or doughnuts" : "Verschiedene Diagrammtypen wie Linien, Säulen oder Donuts",
    ...
    "Show your most important insights in the Nextcloud Dashboard" : "Zeigen Sie Ihre wichtigsten Erkenntnisse im Nextcloud-Dashboard",
    "Interactive tables" : "Interaktive Tabellen",
    "Use thresholds to mark exceptions or receive Nextcloud notifications" : "Verwenden Sie Schwellenwerte, um Ausnahmen zu markieren oder Nextcloud-Benachrichtigungen zu erhalten",
    "Slice and dice your data" : "Analysieren Sie Ihre Daten",
    ...
    "Advanced configuration: Data loads" : "Erweiterte Einrichtung: Datenladungen",
    ...
    "Trigger data loads via scripts using the occ command" : "Datenladungen über Skripte mit dem occ-Befehl auslösen",
