OC.L10N.register(
    ...
    "Gain a comprehensive view of your data with Nextcloud Dashboard" : "Mit dem Nextcloud Dashboard einen umfassenden Überblick über Ihre Daten verschaffen",
    "Interactive tables for deeper analysis" : "Interaktive Tabellen für tiefergehende Analysen",
    "Set thresholds to highlight exceptions and receive Nextcloud notifications" : "Schwellenwerte festlegen, um Ausnahmen hervorzuheben und Nextcloud-Benachrichtigungen zu erhalten",
    ...
    "Monitor real-time download statistics with GitHub integration" : "Download-Statistiken in Echtzeit mit der GitHub-Integration überwachen",
    ...
    "Persist data from any source directly in Nextcloud" : "Daten aus beliebigen Quellen direkt in Nextcloud speichern",
    "Utilize timestamps to create historical records" : "Zeitstempel nutzen, um historische Aufzeichnungen zu erstellen",
    "Perform full or incremental delta loads" : "Vollständige oder inkrementelle Änderungsladevorgänge durchführen",
    ...
    "Push data into Analytics effortlessly via the REST API" : "Übertragen der Daten mühelos in Analytics über die REST-API",
