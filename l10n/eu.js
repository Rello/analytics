OC.L10N.register(
    ...
    "This report does not have any dataloads. <br>Choose a datasource from the dropdown and press \"+\"" : "Txosten honek ez du datu-kargarik. <br>Aukeratu datu-iturburu bat goitibeherako menutik eta sakatu \"+\"",
    "Choose a dataload from the list to change its settings" : "Aukeratu datu-karga bat zerrendatik bere ezarpenak aldatzeko",
    "Saved" : "Gordeta",
    "Are you sure?" : "Ziur zaude?",
    "Delete dataload" : "Ezabatu datu-karga",
    "Select file" : "Hautatu fitxategia",
    "Datasource simulation" : "Datu-iturburu simulazioa",
    ...
    "Scheduled dataload" : "Antolatutako datu-karga",
    ...
    "New data has been added to dataset {report} via dataload" : "Datu berriak gehitu dira {report} datu-multzoan datu-kargaren bidez",
    ...
    "Limit" : "Muga",
    "Timestamp of dataload" : "Datu-kargaren denbora-zigilua",
    ...
    "This section is used for dataset maintenance and dataload configurations" : "Atal hau datu-sorten mantenu eta datu-kargen konfiguraziorako erabiltzen da",
    ...
    "10 min" : "10 min",
    "30 min" : "30 min",
    "New Report Wizard" : "Txosten morroi berria",
    "Choose a name for the report" : "Aukeratu izen bat txostenarentzat",
    "Subheader" : "Azpititulua",
    "Datasource" : "Datu-iturburua",
    "Saved Data" : "Gordetako datuak",
    "Datasource options" : "Datu-iturburuaren aukerak",
    ...
    "Thresholds can trigger notifications and color coding in reports" : "Atalaseak jakinarazpenak abiarazi eta txostenen kolorea aldatu ditzake",
    ...
    "Realtime Data" : "Denbora errealeko datuak",
    "Stored Data" : "Gordetako datuak",
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Txostenek beren datuak irakur ditzakete denbora errealeko datu-iturrietatik edo Nextcloud datu-basean gordetako datu-multzoetatik.",
    "Different data sources are available. The data is read in realtime when the report is being executed." : "Datu-iturburu desberdinak daude eskuragarri. Datuak denbora errealean irakurtzen dira txostena exekutatzen ari den bitartean.",
    "Every datasource requires specific parameter. Please enter the information." : "Datu-iturburu bakoitzak parametro zehatza behar du. Mesedez, sartu informazioa.",
