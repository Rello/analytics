OC.L10N.register(
    ...
    "This report does not have any data loads. <br>Choose a data source from the dropdown and press \"+\"" : "Този отчет няма заредени данни. <br>Изберете източник на данни от падащото меню и натиснете \"+\"",
    ...
    "back" : "назад",
    "Aggregate values (beta)" : "Агрегирани /обобщени/ стойности (бета)",
    "Disaggregate values (beta)" : "Дезагрегирани стойности (бета)",
    ...
    "Selection" : "Избор",
    "No data load created yet" : "Все още не е създадено зареждане на данни",
    "Setting" : "Настройка",
    "Title" : "Заглавие",
    ...
    "Advanced configuration - Data loads" : "Разширена конфигурация - Зареждане на данни",
