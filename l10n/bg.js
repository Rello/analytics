OC.L10N.register(
    ...
    "Connect data from different sources in one place.\nEnable flexible reports and enjoy seamless Nextcloud integration.\nVisualize and share anything, from financial analysis to IoT logs.\n\n##### Features:\n- Data sources: csv, spreadsheet, API, imports, manual entry\n- 3rd party: GitHub Statistics, website grabber, JSON\n- Register external data sources from other apps\n- Storage: real-time or database\n- Advanced data loads with scheduling\n- Visualization: combined charts, tables, filters\n- Analysis functions: trend\n- Thresholds for alerts and color coding\n- Integration: Files, Activity, Notifications, Flow, Dashboard, Search\n- Sharing: user, groups, link" : "Свържете данни от различни източници на едно място.\n Активирайте гъвкавите доклади и се насладете на безпроблемната интеграция на Nextcloud.\n Визуализирайте и споделяйте всичко, от финансов анализ до IoT регистрационни файлове/журнали/.\n\n##### Характеристики:\n- Източници на данни: csv, електронна таблица, API, импортиране, ръчно въвеждане\n- 3-та страна: GitHub Statistics, грабер на уеб сайт, JSON\n- Регистрирайте външни източници на данни от други приложения\n- Хранилище: в реално време или база данни\n- Разширено зареждане на данни с планиране\n- Визуализация: комбинирани диаграми, таблици, филтри\n- Функции за анализ: тенденция\n- Прагове за сигнали и цветово кодиране\n- Интеграция: файлове, активност, известия, поток, табло за управление, търсене\n- Споделяне: потребител, групи, връзка",
    ...
    "Realtime Data" : "Данни в реално време",
    "Stored Data" : "Архивирани данни",
    "Reports can read their data either from realtime data sources or from saved datasets within the Nextcloud database." : "Отчетите могат да четат своите данни или от източници на данни в реално време, или от запазени набори от данни в базата данни Nextcloud.",
    "Different data sources are available. The data is read in realtime when the report is being executed." : "Налични са различни източници на данни. Данните се четат в реално време, когато докладът се изпълнява.",
