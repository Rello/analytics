OC.L10N.register(
    ...
    "Previous Values: " : "Предишни стойности:",
    "Enter the fixed value:" : "Въведи фиксирана стойност:",
    ...
    "Table options" : "Опции",
    "The table can be customized by positioning the rows and columns. <br>If a classic list view is required, all fields need to be placed in the rows section." : "Таблицата може да бъде променена чрез поставяне на редове и колони. 1. Ако е необходим класически изглед като на лист, всички полета трябва да се поставят в секцията за редове.",
    ...
    "No dataset yet" : "Все още няма данни",
    ...
    "Connect data from different sources in one place.\nUse flexible Panoramas and reports with seamless Nextcloud integration.\nVisualize and share anything, from financial analysis to IoT logs.\n\n\n#### Features:\n- Visualization: **Panoramas**, reports, charts, tables, filters\n- Data sources:\n  - csv, spreadsheet, API, import, manual entry\n  - Nextcloud Files, Forms, Tables\n  - external: GitHub, website grabber, JSON\n- Register external data sources from other apps\n- Storage: **real-time** or database\n- Advanced data loads with scheduling\n- Analysis functions: **trend**, dis-/aggregation\n- Thresholds for alerts and color coding\n- Sharing: user, groups, link\n- Integration: Files, Activity, Notifications, Flow, Dashboard, Search, Smart picker, Translation\n- **AI Assistant**: Context Chat integration" : "Свържете данни от различни източници на едно място. \nИзползвайте гъвкави Панорами и доклади с безпроблемна интеграция в Nextcloud.\nВизуализирайте и споделяйте всичко - от финансова анализа до IoT логове.\n\n\n#### Функции:\n- Визуализация: **Панорами**, доклади, графики, таблици, филтри\n- Източници на информация могат да са:\n- csv и електронни таблици, API, качване от файл, ръчно въвеждане\n- Nextcloud източници като Файлове, Формуляри, Таблици\n- външни източници: GitHub, уеб сайт grabber, JSON\n- Регистрирайте външни източници от други приложения\n- Съхранявайте: **в реално време** или база данни\n- Разширено зареждане/качване на данни по зададен график\n- Функции за анализ: **тренд**, дис-/агрегация\n- Прагове за предупреждения и оцветяване\n- Споделяне с: потребител, групи, директна връзка (линк)\n- Интеграция: Файлове, Активност, Известия, Поток, Табло, Търсене, Умен селектор, Превод\n- **AI Асистент**: Интеграция с Context Chat",
    ...
    "Calculated columns" : "Изчислени колони",
    ...
    "In rows" : "В редове",
    "A list of values. This is the default." : "Списък от стойности. Това е по подразбиране.",
    "In columns" : "В колони",
    "One line per topic with the values in the columns" : "Един ред на тема със стойности в колоните",
    "Timestamps in first column" : "Времевите маркери в първата колона",
    "One line per timestamp with the series in the columns" : "Един ред на времеви отрязък със сериите в колоните",
